...
const PlaceOrder = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const orderData = {
      ...
      success_url:  'http://localhost:3000/viewOrder' || 'https://store.onepc.online/viewOrder',
      cancel_url:  'http://localhost:3000/placeOrder'  || 'https://store.onepc.online/placeOrder'
    };
